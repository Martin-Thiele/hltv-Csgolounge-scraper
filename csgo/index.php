...
<title>CSGO - Brintos.dk</title>
<meta name="description" content="A website to help CS:GO betters determine the winners of CS:GO Matches. Statistics, Recent matches, Winrates, Players, Teams." />
</head>
<body>
<div class="wrap">
<h1>Matches</h1>
<p>Today, the 28th of april, hltv decided to ban my ip, so i assume that they do not want me to continue this project. I respect their decision, and will not try to circumvent the ban, was fun and i learned a lot. Farewell.</p>
...
$threedate = (date('Y-m.d', strtotime(date("Y-m-d"). ' + 3 days')));
