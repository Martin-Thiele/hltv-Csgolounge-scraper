...
<?php 
$subcid = ($_GET['subcid']);
if($subcid != 0 AND $subcid != null){
    $resultsql = "SELECT * FROM Subcomp WHERE subcid = $subcid LIMIT 1";
...
FROM Matches m WHERE subcid = $subcid) AS T
...
if ($result->num_rows > 0) {
    ...
    echo "No matches found for this subcompetition";
}
