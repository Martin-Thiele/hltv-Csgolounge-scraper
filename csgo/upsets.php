...
FROM Matches m WHERE complete = 1 AND csglodds1 != 0 AND csglodds2 != 0 AND (csglodds1 < 11 OR csglodds2 < 11)) AS T
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
       ...
       if(($row['csglodds1'] < 11 && $t1win > $t2win) || $t2win > $t1win && $row['csglodds2'] < 11){
